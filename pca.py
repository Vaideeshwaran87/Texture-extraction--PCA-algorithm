...
if __name__ == "__main__":
    ...
    input_folder = r'V:\calorie_estimation\IndianFoodImages\IndianFoodImages\butterr_chicken'

    # Output folder to store preprocessed images
    output_folder = r'V:\calorie_estimation\ExtractedFeatures\butterr_chicken'
